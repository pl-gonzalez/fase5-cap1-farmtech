...
O notebook `Nome_RMXXXXX_pbl_fase4.ipynb` contém todo o desenvolvimento, organizado em seções com:
- Código Python comentado e otimizado
- Visualizações e tabelas
- Células markdown com a descrição dos achados e conclusões

### 🎥 **Vídeo de Demonstração**
[https://youtu.be/SEU_LINK_AQUI](https://youtu.be/SEU_LINK_AQUI) – vídeo não listado (5 minutos) com a explicação do projeto.

---

**Equipe:** [Nomes e RMs]  
**Disciplina:** FarmTech Solutions – Fase 4/5  
**Data:** Março/2025
